...
export class Backend implements backendInterface {
    ...
    async addTestimonial(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<bigint> {
    ...
    async submitAppointment(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async submitContactForm(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<boolean> {
        if (this.processError) {
            try {
